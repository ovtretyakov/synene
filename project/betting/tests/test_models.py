...
class OddModelTest(TestCase):
    ...
    def test_odd_wdl_calculate(self):
        ...
        result, result_value = odd1.get_result(odd_value=4)
        self.assertEquals(result, Odd.SUCCESS)
        self.assertEquals(result_value, 4)
        #yes=N
        ...
        result, result_value = odd2.get_result(odd_value=4)
        self.assertEquals(result, Odd.FAIL)
        self.assertEquals(result_value, 0)
        #FAIL
    ...
    def test_odd_total_over_calculate(self):
        ...
        result, result_value = odd3.get_result(odd_value=4)
        self.assertEquals(result, Odd.SUCCESS)
        self.assertEquals(result_value, 4)
        odd4.calculate_result()
        ...
        result, result_value = odd4.get_result(odd_value=4)
        self.assertEquals(result, Odd.PART_SUCCESS)
        self.assertEquals(result_value, 2.5)
        odd5.calculate_result()
        ...
        result, result_value = odd5.get_result(odd_value=4)
        self.assertEquals(result, Odd.RETURN)
        self.assertEquals(result_value, 1)
        odd6.calculate_result()
        ...
        result, result_value = odd6.get_result(odd_value=4)
        self.assertEquals(result, Odd.PART_FAIL)
        self.assertEquals(result_value, 0.5)
        ...
        result, result_value = odd7.get_result(odd_value=4)
        self.assertEquals(result, Odd.FAIL)
        self.assertEquals(result_value, 0)
