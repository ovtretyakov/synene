...
def prepare_data(obj):
    ...
    #GOAL_TIME
    MatchStats.objects.create(match=obj.match1, stat_type=Match.GOAL_TIME, competitor=Match.COMTETITOR_HOME, period=0, value='12,53')
    MatchStats.objects.create(match=obj.match1, stat_type=Match.GOAL_TIME, competitor=Match.COMTETITOR_AWAY, period=0, value='54,70')
    ###### match2
    ...
    #GOAL_TIME
    MatchStats.objects.create(match=obj.match2, stat_type=Match.GOAL_TIME, competitor=Match.COMTETITOR_HOME, period=0, value='43,46,90')
    MatchStats.objects.create(match=obj.match2, stat_type=Match.GOAL_TIME, competitor=Match.COMTETITOR_AWAY, period=0, value='47')
