...
class Migration(migrations.Migration):
    ...
    def create_parimatch_config(apps, schema_editor):
        ...
        PARIMATCH_ODDS = {
            ...
            "To score over 1,5 goals Neither Team":{"type":BType.ITOTAL_ONLY_OVER, "period":"0", "param":"1.50", "team":"", "yes":0},
            ...
            "Both teams to score in 1st half & 2nd half Neither team":{"type":BType.ITOTAL_ONLY_OVER_IN_BOTH_HALVES, "period":"0", "param":"0.50", "team":"", "yes":1},
            ...
            "At least one team to score 2 or more goals no": {"type":BType.ITOTAL_BOTH_UNDER, "period":"0", "param":"1.50", "team":"", "yes":1},
            "At least one team to score 3 or more goals yes": {"type":BType.ITOTAL_AT_LEAST_OVER, "period":"0", "param":"2.50", "team":"", "yes":1},
            "At least one team to score 3 or more goals no": {"type":BType.ITOTAL_BOTH_UNDER, "period":"0", "param":"2.50", "team":"", "yes":1},
            ...
            "Match goal - 76th minute to Full Time? yes": {"type":BType.TOTAL_OVER_MINUTES, "period":"90", "param":"0.50", "team":"", "yes":1},
            "Match goal - 76th minute to Full Time? no":  {"type":BType.TOTAL_UNDER_MINUTES,"period":"90", "param":"0.50", "team":"", "yes":1},
            ...
            "At least one team to score 4 or more goals no":  {"type":BType.ITOTAL_BOTH_UNDER,"period":"0", "param":"3.50","team":"", "yes":1},
            ...
            "Highest scoring half draw":           {"type":BType.HIGHEST_VALUE_HALF,"period":"", "param":"x", "team":"", "yes":1},
            ...
            "The half with more goals scored by Equal":      {"type":BType.HIGHEST_VALUE_HALF,"period":"", "param":"x", "team":"", "yes":1},
